...
namespace ConfigEditor.Dom
{
	...
	/// </summary>
	public static class DomMergeService
	{
		/// <summary>
		/// Merges multiple cascade layers into a single DOM tree.
		/// Later layers override earlier ones.
		/// </summary>
		public static ObjectNode MergeCascade( List<CascadeLayerSource> layers, MergeOriginTracker tracker )
		{
			if( layers.Count == 0 )
		...
		private static void MergeObjectInto( ObjectNode target, ObjectNode source, SourceFile sourceFile, int layerIndex, MergeOriginTracker tracker )
		{
		...
		private static void TrackOriginsRecursive( DomNode node, SourceFile file, int layerIndex, MergeOriginTracker tracker )
		{
