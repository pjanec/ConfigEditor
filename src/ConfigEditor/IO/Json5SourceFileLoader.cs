...
namespace ConfigEditor.IO
{
	...
	public static class Json5SourceFileLoader
	{
		...
		public static List<SourceFile> LoadAllFromFolder( string folder )
		{
		...
		public static SourceFile LoadSingleFile( string filePath, string? baseFolder = null )
		{
			...
			return new SourceFile( filePath, relativePath, dom, text );
		}
	}
}
